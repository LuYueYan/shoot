    ...
    async onFile(file: plugins.File) {
        if (file.extname == '.js') {
            ...
            if (filename == 'libs/modules/egret/egret.js' || filename == 'libs/modules/egret/egret.min.js') {
                ...
                if (filename == 'libs/md5/md5.js' || filename == 'libs/md5/md5.min.js') {
                    content += ';window.md5 = md5;';
                }
                if (filename == 'libs/physics/physics.js' || filename == 'libs/physics/physics.min.js') {
                    content += ';window.p2 = module.exports;';
                }
